...
router.delete('/:id', postController.deletePost); // userAuth
...
router.patch('/edit-commentPost/:id', postController.editCommentPost); // adminAuth
router.patch('/delete-commentPost/:id', postController.deleteCommentPost); // adminAuth
